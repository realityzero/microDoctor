...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            w.setNavigationBarColor(Color.parseColor("#4D000000"));
        }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Button chemistButton = (Button) findViewById(R.id.chemistButton);
        chemistButton.setOnClickListener(new View.OnClickListener() {
            String Chemist = "chemist|pharmacy|dispensary|drugstore|medical|druggist|pharmaceuticals";
            @Override
            public void onClick(View v) {
                Log.d("onClick", "Button is Clicked");
                mMap.clear();
                String url = getUrl(latitude, longitude, Chemist);
                ...
                Toast.makeText(MapsActivity.this,"Nearby Chemists", Toast.LENGTH_LONG).show();
            }
        });
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlacesUrl.append("&key=" + "AIzaSyCQ3VDME_d8V5ndsfWh8m_ZoInhBHMfYRY");
